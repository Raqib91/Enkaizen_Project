...
<body>
	...
	<center>
		...
		<div class="container">
			...
			<div class="card">
				<div class="card-body">
					<form action="adminUpdateTodo" method="post">
						<input type="hidden" name="todoId" value="<%= t.getTodoId()%>">
						
						<div class="form-group">
							<label>Enter Todo Title:</label> <input type="text"
								class="form-control" name="todoTitle" value="<%= t.getTodoTitle()%>">
						</div>
						<div class="form-group">
							<label>Enter Todo Description:</label> <input type="text"
								class="form-control" name="todoDescription" value="<%= t.getTodoDescription()%>">
						</div>
