...
<body>
	...
	<div class="head">
		<div class="leftside">
			<h3><i class="fas fa-user-circle"></i> Hello Admin!</h3>
		</div>
		<div class="rightside">
			<a href="createTodo.jsp" target="_blank">
